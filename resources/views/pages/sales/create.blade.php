                ...
                <div class="cart-container col-lg-8">
                    <section class="row p-2">
                        ...
                        <div class="col-lg-3 offset-lg-5 pl-5 mt-2 total-amount">
                            <label for="">
                                A cuenta:
                                <input type="number" id="partialPayment" class="form-control ml-2" value="0.00" readonly
                        ...
                        <div class="col-lg-4 mt-2 total-amount pr-5">
                        ...
                        <div class="input-group form-group">
                            <div class="input-group input-group-alternative">
                                ...
                                <select class="form-control" name="saleType" id="saleType"
                                    onchange="changeSaleType(this.value)">
                    ...
                    <div class="col-lg-12 favorites-container">
                        <section class="favorites-container-products" id="containerProductsByCategory">
                            ...
                            <span class="badge badge-pill badge-info p-2"
                                onclick="addProduct({{ json_encode(['id' => $product->id, 'name' => $product->name, 'quantity' => 1, 'prices' => $product->sales_prices, 'price' => $product->sales_prices[0], 'stock' => $product->stock, 'hasContainer' => $product->has_container]) }})">{{
                                $product->name }}
                            </span>
                            @endforeach
                        </section>
