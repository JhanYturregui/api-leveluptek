                ...
                <table id="mainTable" class="table align-items-center table-flush">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th scope="col" class="sort" data-sort="name">{{ __('NOMBRE / RAZÓN SOCIAL') }}</th>
                            <th scope="col" class="sort" data-sort="name">{{ __('TELÉFONO') }}</th>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>{{ __('¿Deseas eliminar este proveedor?') }}</p>
            </div>
