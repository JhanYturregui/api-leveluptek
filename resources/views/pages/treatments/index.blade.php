@extends('layouts.app', ['title', 'prueba'])
    ...
    <div class="col">
      <div class="card">
        ...
        {{--
          ...
          <div class="row">
          <h3 class="mb-0 col-8">{{ __('Gestión de Tratamientos') }}</h3>
          <div class="col-4 text-right">
          <a href="{{ route('treatments_create') }}" class="btn btn-primary botones-expand">
          ...
          <table id="mainTable" class="table align-items-center table-flush">
            <thead class="thead-light">
              <tr>
                ...
                <th scope="col" class="sort" data-sort="name">{{ __('TRATAMIENTO') }}</th>
                <th scope="col" class="sort" data-sort="name">{{ __('PRECIO') }}</th>
                <th scope="col" class="sort" data-sort="name">{{ __('MATERIALES') }}</th>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p>{{ __('¿Deseas eliminar este tratamiento?') }}</p>
        </div>
