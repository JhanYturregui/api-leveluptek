            ...
            <div class="table-responsive p-4">
                <table id="mainTable" class="table align-items-center table-flush">
                    <thead class="thead-light">
                        <tr>
                            <th scope="col" class="sort" data-sort="name">{{ __('NÚMERO DOCUMENTO') }}</th>
                            <th scope="col" class="sort" data-sort="name">{{ __('NOMBRE COMPLETO') }}</th>
                            <th scope="col" class="sort" data-sort="name">{{ __('LÍMITE CRÉDITO') }}</th>
                            <th scope="col" class="sort" data-sort="name">{{ __('DISPONIBLE') }}</th>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>{{ __('¿Deseas eliminar este cliente?') }}</p>
            </div>
